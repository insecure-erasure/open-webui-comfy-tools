...
| 2026-08-04 | 1 | Visual polish: smaller opaque handle + invert divider (phase reopened) | Handle reduced to ~30%% (10×14px) and fully opaque; divider now translucent white with `mix-blend-mode: difference` so it inverts the colors it passes over. Commit `…` |
