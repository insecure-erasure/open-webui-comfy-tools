...
| 2026-08-04 | 1 | Restore desktop hover + handle at 40%% (phase reopened) | Divider follows the mouse on hover (desktop) while keeping click/tap jump and touch drag (`pointermove` acts also for mouse with no button). Handle resized to 13×18px (~40%% of original). Commit `…` |
